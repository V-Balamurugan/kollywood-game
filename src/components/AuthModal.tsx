...
export const AuthModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-fade-in overflow-y-auto">
      <div className="relative w-full max-w-lg glass-card border border-cinema-border/90 rounded-3xl p-5 sm:p-7 shadow-2xl overflow-hidden my-auto max-h-[94vh] overflow-y-auto">
        ...
        <button
          ...
          className="absolute top-4 sm:top-5 right-4 sm:right-5 p-2 rounded-xl bg-cinema-surface text-slate-400 hover:text-white border border-cinema-border/60 transition-colors z-10"
        >
        ...
        {mode === 'welcome' && (
          <div className="space-y-5 animate-fade-in">
            ...
            <div className="text-center pt-2">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand-500/15 border border-brand-500/30 text-brand-300 text-xs font-black uppercase tracking-wider mb-3">
            ...
            <div className="grid grid-cols-1 gap-3 pt-1">
              ...
              <button
                ...
                className="group relative w-full p-4 sm:p-5 rounded-2xl bg-cinema-surface hover:bg-cinema-cardHover border border-brand-500/40 hover:border-brand-400 text-left transition-all active:scale-[0.99] shadow-lg"
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3.5">
                    <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-brand-400 to-amber-500 flex items-center justify-center text-black shadow-md shadow-brand-500/30 flex-shrink-0 group-hover:scale-105 transition-transform">
                      <Zap className="w-5 h-5 fill-black" />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="text-sm sm:text-base font-black font-display text-white group-hover:text-amber-300 transition-colors">
                          Play as Guest
                        </h3>
                        <span className="text-[10px] bg-brand-500/20 text-brand-300 font-black px-2 py-0.5 rounded-full border border-brand-500/30">
                          Instant Play
                        </span>
                      </div>
                  ...
                  <div className="w-8 h-8 rounded-xl bg-brand-500/20 text-brand-300 flex items-center justify-center group-hover:translate-x-1 transition-transform flex-shrink-0">
              ...
              <button
                ...
                className="group relative w-full p-4 sm:p-5 rounded-2xl bg-cinema-surface hover:bg-cinema-cardHover border border-cinema-border hover:border-cyan-500/50 text-left transition-all active:scale-[0.99]"
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3.5">
                  ...
                  <div className="w-8 h-8 rounded-xl bg-cinema-dark text-slate-400 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all flex-shrink-0">
                    <ArrowRight className="w-4 h-4" />
                  </div>
                </div>
              </button>
              ...
              <button
                ...
                className="group relative w-full p-4 sm:p-5 rounded-2xl bg-cinema-surface hover:bg-cinema-cardHover border border-cinema-border hover:border-purple-500/50 text-left transition-all active:scale-[0.99]"
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3.5">
                  ...
                  <div className="w-8 h-8 rounded-xl bg-cinema-dark text-slate-400 group-hover:text-purple-400 group-hover:translate-x-1 transition-all flex-shrink-0">
                    <ArrowRight className="w-4 h-4" />
                  </div>
                </div>
              </button>
            ...
            <div className="pt-2">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-2.5 py-3 px-4 rounded-2xl bg-cinema-surface hover:bg-cinema-cardHover border border-cinema-border text-white text-xs sm:text-sm font-bold transition-all disabled:opacity-50"
              >
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex items-center justify-between mb-4">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-cinema-muted hover:text-brand-300 transition-colors"
              >
                <ArrowLeft className="w-4 h-4" />
                <span>All Options</span>
              </button>

              <span className="text-[11px] text-cinema-muted font-mono font-bold">
            ...
            <div className="flex items-center gap-3 mb-5 pr-6">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-brand-500/15 text-brand-400 border border-brand-500/30 flex items-center justify-center shadow-lg shadow-brand-500/10 flex-shrink-0">
            ...
            {/* Mode Selector Tabs */}
            <div className="grid grid-cols-3 gap-1 bg-cinema-dark p-1 rounded-2xl border border-cinema-border/70 mb-5">
              <button
                type="button"
                onClick={() => { setMode('guest'); setAuthModalMode('guest'); setError(null); }}
                className={`py-2 text-xs font-black rounded-xl transition-all ${mode === 'guest'
              ...
              <button
                ...
                className={`py-2 text-xs font-black rounded-xl transition-all ${mode === 'signin'
                    ? 'btn-cinema-primary text-black'
                    : 'text-slate-400 hover:text-white'
                  }`}
              >
              ...
              <button
                ...
                className={`py-2 text-xs font-black rounded-xl transition-all ${mode === 'signup'
                    ? 'btn-cinema-primary text-black'
                    : 'text-slate-400 hover:text-white'
                  }`}
              >
            ...
            {/* Error Display */}
            {error && (
              <div className="mb-4 p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs leading-relaxed space-y-2">
                <div>
                  ...
                  <div className="pt-2 border-t border-rose-500/20 space-y-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2 px-3 rounded-xl bg-cinema-surface hover:bg-brand-500/20 border border-cinema-border text-brand-300 font-bold text-xs"
                      >
                        👉 Sign Up
                      </button>
                      <button
                        ...
                        className="flex-1 py-2 px-3 rounded-xl btn-cinema-primary text-black font-black text-xs"
                      >
                        ⚡ Play as Guest
                      </button>
                    </div>
            ...
            {mode !== 'guest' && (
              <div className="mb-4">
                <button
                  ...
                  onClick={handleGoogleSignIn}
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 rounded-2xl bg-cinema-surface hover:bg-cinema-cardHover border border-cinema-border text-white text-xs sm:text-sm font-bold transition-all disabled:opacity-50"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24">
                    <path fill="#EA4335" d="M12 5c1.6 0 3 .6 4.1 1.6l3.1-3.1C17.3 1.7 14.8 1 12 1 7.5 1 3.7 3.6 1.9 7.3l3.7 2.9C6.5 7.4 9 5 12 5z" />
                    <path fill="#4285F4" d="M23.5 12.3c0-.8-.1-1.6-.2-2.3H12v4.5h6.5c-.3 1.5-1.1 2.8-2.4 3.7l3.7 2.9c2.2-2 3.7-5 3.7-8.8z" />
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {['ThalapathyFan', 'SuperstarBuff', 'AnirudhVibe', 'CinemaRasigan'].map((nick) => (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-cinema-surface hover:bg-brand-500/20 border border-cinema-border/70 hover:border-brand-500/40 text-[11px] text-slate-300 hover:text-brand-300 transition-colors"
                        >
                          +{nick}
                        </button>
                      ))}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-3 py-3.5 rounded-2xl btn-cinema-primary text-black font-black text-sm shadow-xl active:scale-[0.99] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {loading ? (
